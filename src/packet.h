...
/**
 * Заполняет пакет с IP-заголовком и TCP-заголовком для сканирования TCP-SYN
 * @param setup_info  - информация для заполнения пакета
 * @param packet      - указатель на буфер, заполняемый заголовками IP и TCP
